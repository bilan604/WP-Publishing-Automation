...
async def prompt_gpt3(keyword, text):
    prompt = "The following text is from a website from the a Google search for \"" + keyword + "\". "
    prompt += "Please find and summarize all statistics related to \"" + keyword+ "\" from the text:\n\n"
    prompt += "\"\"\"\n" + text + "\"\"\"\n\n"
